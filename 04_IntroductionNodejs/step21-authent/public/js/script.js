...
// Adds a background blur/solid color when the user scrolls down
...
// Opens the sidebar, changes icon to 'close', and locks scroll
function toggleMenu() {
  ...
  if (navLinks) {
    ...
    // Scroll Lock (Fix for mobile dashboard scroll issue)
    body.style.overflow = isOpen ? "hidden" : "auto";
  }
}

// 3. PASSWORD VISIBILITY TOGGLE
// Usage: onclick="togglePassword('inputId', 'iconId')"
...
document.addEventListener("DOMContentLoaded", () => {
  // A. Auto-hide alert messages after 5 seconds
